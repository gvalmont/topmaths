...
describe('compteLesReponsesDifferentes', () => {
  ...
  it('texteAvecCasse: distingue la casse', () => {
    ...
    expect(
      aLeBonNombreDePropsDifferentes(exo, 3, true, { texteAvecCasse: true }),
    ).toBe(true)
    exo.reponses = ['Bonjour', 'Bonjour', 'BONJOUR']
    expect(
      aLeBonNombreDePropsDifferentes(exo, 3, true, { texteAvecCasse: true }),
  ...
  it('texteSansCasse: ignore la casse', () => {
    ...
    exo.reponses = ['Bonjour', 'bonjour', 'BONJOUR']
    expect(
      aLeBonNombreDePropsDifferentes(exo, 3, true, { texteSansCasse: true }),
    ).toBe(false)
  ...
  it('fractions: fractionEgale', () => {
    ...
    expect(
      aLeBonNombreDePropsDifferentes(exo, 3, true, { fractionEgale: true }),
    ).toBe(false)
  ...
  it('intervalles: intervalle', () => {
    ...
    expect(
      aLeBonNombreDePropsDifferentes(exo, 3, true, { intervalle: true }),
    ).toBe(false)
    exo.reponses = ['[1;2]', '[2;3]', '[3;4]']
    expect(
      aLeBonNombreDePropsDifferentes(exo, 3, true, { intervalle: true }),
  ...
  it('ensembles: ensembleDeNombres', () => {
    ...
    expect(
      aLeBonNombreDePropsDifferentes(exo, 3, true, { ensembleDeNombres: true }),
    ).toBe(false)
  ...
  it('unités: unite', () => {
    ...
    expect(
      aLeBonNombreDePropsDifferentes(exo, 3, true, {
        unite: true,
  ...
  it('puissances: puissance', () => {
    ...
    expect(
      aLeBonNombreDePropsDifferentes(exo, 3, true, { puissance: true }),
    ).toBe(false)
  ...
  it("égalité d'expressions: egaliteExpression", () => {
    ...
    expect(
      aLeBonNombreDePropsDifferentes(exo, 3, true, { egaliteExpression: true }),
    ).toBe(false)
  ...
  it('suites de nombres: suiteDeNombres', () => {
    ...
    exo.reponses = ['1;2;3', '3;2;1', '4;5;6']
    expect(
      aLeBonNombreDePropsDifferentes(exo, 3, true, { suiteDeNombres: true }),
    ).toBe(false)
    exo.reponses = ['1;2;3', '4;5;6', '7;8;9']
    expect(
      aLeBonNombreDePropsDifferentes(exo, 3, true, { suiteDeNombres: true }),
  ...
  it('coordonnées: coordonnees', () => {
    ...
    expect(
      aLeBonNombreDePropsDifferentes(exo, 3, true, { coordonnees: true }),
    ).toBe(false)
    exo.reponses = ['(1;2)', '(2;3)', '(3;4)']
    expect(
      aLeBonNombreDePropsDifferentes(exo, 3, true, { coordonnees: true }),
  ...
  it('HMS: heures/minutes/secondes', () => {
    ...
    expect(aLeBonNombreDePropsDifferentes(exo, 3, true, { HMS: true })).toBe(
      false,
    )
