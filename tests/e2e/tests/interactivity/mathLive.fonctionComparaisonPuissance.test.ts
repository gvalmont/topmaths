...
async function test (page: Page) {
  ...
  // Test désactivé le 6/10/24 en attendant la mise à jour de Compute Engine fautif sur des faux négatifs.
  // Exemple avec http://localhost:5173/alea/?uuid=1d078&id=4C33-0&n=4&d=10&s=2&s2=3&s3=1&s4=3&alea=hpGl&i=1&cd=1
  // -2^6 est accepté alors qu'il est faux
