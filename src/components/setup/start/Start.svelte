...
{#if $globalOptions.v === '' || $globalOptions.v === undefined || $globalOptions.v === 'start'}
  <div
  ...
  ========================================================================================= -->
        ...
        >
          ...
          >
            ...
            {#if $exercicesParams.length !== 0 && ($globalOptions.v === '' || $globalOptions.v === undefined || $globalOptions.v === 'start')}
