...
#exemple()[
  ...
  #grid(
    columns: 4,
    rows: 1,
    cell()[#figure(image("6G6A-1.png"), caption: [Étape 1])], cell()[#figure(image("6G6A-2.png"), caption: [Étape 2])], cell()[#figure(image("6G6A-3.png"), caption: [Étape 2])], cell()[#figure(image("6G6A-4.png"), caption: [Étape 3])],
  )
]
