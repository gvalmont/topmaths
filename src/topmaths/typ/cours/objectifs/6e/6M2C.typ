...
#exemple(titre: "Exemple avec des cm")[
  #align(horizon, grid(
    columns: 3,
    column-gutter: 1em,
    image("6M2C-5.png", height: 6em), "→", image("6M2C-6.png", height: 6em),
  ))
...
#exemple(titre: "Exemple avec des m")[
  #align(horizon, grid(
    columns: 3,
    column-gutter: 1em,
    image("6M2C-7.png", height: 8em), "→", image("6M2C-8.png", height: 8em),
  ))
...
#exemple(titre: "Exemple avec des virgules")[
  #align(horizon, grid(
    columns: 3,
    column-gutter: 1em,
    image("6M2C-9.png", height: 6em), "→", image("6M2C-10.png", height: 6em),
  ))
...
#exemple(titre: "Exemple avec des lettres")[
  #align(horizon, grid(
    columns: 3,
    column-gutter: 1em,
    image("6M2C-11.png", height: 8em), "→", image("6M2C-12.png", height: 8em),
  ))
...
#remarque(titre: "Résumé")[
  ...
  #table(columns: 4, rows: (1.5em, 4em, 1.5em), align: horizon + center)[
    ...
    Figure][#image("6M2C-15.png")][#image("6M2C-16.png")][#image("6M2C-17.png")][
