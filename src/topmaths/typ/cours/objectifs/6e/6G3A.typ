...
#exemple()[
  #place(right, image("6G3A-1.png", width: 20%), dx: 7%, dy: -1em)
  #block(width: 95%)[
    #show: normal
...
#exemple()[
  #implication(
    [Le point C #rouge()[appartient à la médiatrice] du segment [AB].#image("6G3A-2.png")],
    [Le point C est #vert()[équidistant] de A et de B.#image("6G3A-3.png")],
  )
]
...
#exemple()[
  #implication(
    [Le point C est #vert()[équidistant] de A et de B.#image("6G3A-4.png")],
    [Le point C #rouge()[appartient à la médiatrice] du segment [AB].#image("6G3A-5.png")],
  )
]
