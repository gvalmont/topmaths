...
#exemple()[
  ...
  On remarque que ce solide est constitué de plusieurs cubes d'arête $1 "cm"$ :
  ...
  Comme ce solide est constitué de $72$ cubes d'arête $1 "cm"$, on dit qu'il a un volume de $72 "cm" ^3$ ($72$ centimètres cubes)
]
