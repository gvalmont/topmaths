#definitions()[
  #align(
    ...
    grid(
      ...
      row-gutter: 1em,
      column-gutter: 0.5em,
      align(center, image("6G8B-1.png", height: 4em)), [Le #motDefini()[cube] est un solide uniquement constitué de carrés.],
      align(center, image("6G8B-2.png", height: 4em)), [Le #motDefini()[pavé droit], qu’on appelle aussi #motDefini()[parallélépipède rectangle] est un solide uniquement constitué de rectangles.],
      align(center, image("6G8B-3.png", height: 4em)),
      ...
      align(center, image("6G8B-4.png", height: 4em)),
      ...
      align(center, image("6G8B-5.png", height: 4em)), [Le #motDefini()[cylindre] est un solide uniquement constitué d’une surface latérale et de deux disques qu’on appelle les #motDefini()[bases] du cylindre.],
      align(center, image("6G8B-6.png", height: 4em)), [Le #motDefini()[cône] est un solide uniquement constitué d’une surface latérale et d’un disque qu’on appelle la #motDefini()[base] du cône.],
      align(center, image("6G8B-7.png", height: 4em)),
