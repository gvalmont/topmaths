...
#table(
  columns: 6,
  stroke: gray,
  "Ingrédient", "Beurre", "Farine", "Chocolat", "Sucre", "Lait",
  "Masse (en g)", "250", "200", "100", "200", "150",
)
...
#regle()[
  #place(right, image("6P1E-1.png", width: 50%))
  #block(width: 50%)[
...
#regle()[
  #place(right, image("6P1E-2.png", width: 50%), dy: -2em)
  #block(width: 50%)[
...
#place(right, image("6P1E-4.png", width: 35%), dy: -2em)
#table(
  columns: 7,
  "Ingrédients", "Beurre", "Farine", "Chocolat", "Sucre", "Lait", "Total",
  "Masse (en g)", "250", "200", "100", "200", "150", "900",
  "Angle (en °)", "100", "80", "40", "80", "60", "360",
)
