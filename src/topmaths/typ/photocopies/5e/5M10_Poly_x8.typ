...
#let truc = [
  #grid(
    ...
    table(columns: 6, rows: (1.5em, 4em, 1.5em), align: horizon + center)[
      ...
      Figure][#image("../../cours/objectifs/6e/6M2C-15.png")][#image("../../cours/objectifs/6e/6M2C-16.png")][#image("../../cours/objectifs/6e/6M2C-17.png")][#box(image("5M10-1.png")) #box(image("5M10-2.png"))][#image("5M10-3.png")][
