...
const referenceInfoValidKeys = <const>[
  'site-info',
  'legal-notice',
  'privacy-policy',
  'terms-of-use',
...
const referenceClassroomValidKeys = <const>[
  'mathador',
  'curriculum',
  'prerequisites',
]
...
export function isClassroomReferences(
  obj: unknown,
): obj is ReferenceClassroom[] {
  if (obj == null || !Array.isArray(obj)) return false
  return obj.every(isClassroomReference)
}

const referenceValidKeys = [
  '',
  ...referenceInfoValidKeys,
  ...referenceStudentValidKeys,
  ...referenceClassroomValidKeys,
