const topmathsViewValidKeys = <const>['exercices', 'sequence', 'sequences', 'objectifs', 'objectif', 'revisions', 'outils', 'mathador', 'generateur-de-portraits', 'eleves', 'lexique', 'tutos', 'telechargements', 'progressions', 'informations', 'panier', 'mentions-legales', 'politique-de-confidentialite', 'cgu', 'perso', 'accueil']
