const viewValidKeys = <const>['exercices', 'unit', 'objective', 'revisions', 'outils', 'mathador', 'generateur-de-portraits', 'eleves', 'lexique', 'tutos', 'telechargements', 'progressions', 'panier', 'perso', 'home', 'info']
