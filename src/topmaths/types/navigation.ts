const viewValidKeys = <const>['exercices', 'unit', 'objectifs', 'objectif', 'revisions', 'outils', 'mathador', 'generateur-de-portraits', 'eleves', 'lexique', 'tutos', 'telechargements', 'progressions', 'panier', 'perso', 'home', 'info']
