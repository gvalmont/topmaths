import {
  ...
  isStringArrayRecordStringGrade,
  isStringGrade,
  isStringGrades,
  type StringGrade,
} from './grade.js'
...
export function isObjectiveReferences(
  obj: unknown,
): obj is ObjectiveReference[] {
  if (obj == null || !Array.isArray(obj)) return false
  return obj.every(isObjectiveReference)
}
export const emptyObjectiveReference: ObjectiveReference =
  objectivesReferences[0] // keep in sync with build_prepare.ts

export type ObjectiveAncestor = {
  // keep in sync with ObjectiveAncestorWithStringReference
  reference: ObjectiveReference
  title: string
  titleAcademic: string
  ancestors: ObjectiveAncestor[]
}
export function isObjectiveAncestor(
  obj: unknown,
  withStringReference: boolean = false,
): obj is ObjectiveAncestor {
  ...
  return (
    ...
    'ancestors' in obj &&
    isObjectiveAncestors(obj.ancestors, withStringReference)
  )
}
export function isObjectiveAncestors(
  obj: unknown,
  withStringReference: boolean = false,
): obj is ObjectiveAncestor[] {
  if (obj == null || !Array.isArray(obj)) return false
...
export type ObjectiveAncestorWithStringReference = {
  // keep in sync with ObjectiveAncestor (had to do this because ReplaceReferencesByStrings can't handle recursive types)
  reference: string
  title: string
  titleAcademic: string
  ancestors: ObjectiveAncestorWithStringReference[]
}
export function isObjectiveAncestorWithStringReference(
  obj: unknown,
): obj is ObjectiveAncestorWithStringReference {
  if (obj == null || typeof obj !== 'object') return false
  return (
    'reference' in obj &&
    typeof obj.reference === 'string' &&
    ...
    typeof obj.titleAcademic === 'string' &&
    'ancestors' in obj &&
    isObjectiveAncestorsWithStringReference(obj.ancestors)
  )
}
export function isObjectiveAncestorsWithStringReference(
  obj: unknown,
): obj is ObjectiveAncestorWithStringReference[] {
  if (obj == null || !Array.isArray(obj)) return false
...
export type ObjectiveDescendant = {
  // keep in sync with ObjectiveDescendantWithStringReference
  reference: ObjectiveReference
  title: string
  titleAcademic: string
  descendants: ObjectiveDescendant[]
}
export function isObjectiveDescendant(
  obj: unknown,
  withStringReference: boolean = false,
): obj is ObjectiveDescendant {
  if (obj == null || typeof obj !== 'object') return false
  return (
    'reference' in obj &&
    (withStringReference
    ...
    typeof obj.titleAcademic === 'string' &&
    'descendants' in obj &&
    isObjectiveDescendants(obj.descendants, withStringReference)
  )
}
export function isObjectiveDescendants(
  obj: unknown,
  withStringReference: boolean = false,
): obj is ObjectiveDescendant[] {
  if (obj == null || !Array.isArray(obj)) return false
...
export type ObjectiveDescendantWithStringReference = {
  // keep in sync with ObjectiveDescendant (had to do this because ReplaceReferencesByStrings can't handle recursive types)
  reference: string
  title: string
  titleAcademic: string
  descendants: ObjectiveDescendantWithStringReference[]
}
export function isObjectiveDescendantWithStringReference(
  obj: unknown,
): obj is ObjectiveDescendantWithStringReference {
  if (obj == null || typeof obj !== 'object') return false
  return (
    'reference' in obj &&
    typeof obj.reference === 'string' &&
    ...
    typeof obj.titleAcademic === 'string' &&
    'descendants' in obj &&
    isObjectiveDescendantsWithStringReference(obj.descendants)
  )
}
export function isObjectiveDescendantsWithStringReference(
  obj: unknown,
): obj is ObjectiveDescendantWithStringReference[] {
  if (obj == null || !Array.isArray(obj)) return false
...
export function isObjectiveVideo(obj: unknown): obj is ObjectiveVideo {
  ...
  return (
    ...
    typeof obj.title === 'string' &&
    'videoLink' in obj &&
    typeof obj.videoLink === 'string' &&
    'authorName' in obj &&
    typeof obj.authorName === 'string' &&
    'authorLink' in obj &&
    typeof obj.authorLink === 'string'
  )
}
...
export function isObjectiveLessonPlanSegment(
  obj: unknown,
): obj is ObjectiveLessonPlanSegment {
  if (obj == null || typeof obj !== 'object') return false
  return (
    'steps' in obj &&
    isStrings(obj.steps) &&
...
export function isObjectiveLessonPlanSegments(
  obj: unknown,
): obj is ObjectiveLessonPlanSegment[] {
  if (obj == null || !Array.isArray(obj)) return false
...
export function isObjectiveLessonPlan(
  obj: unknown,
  withStringReference: boolean = false,
): obj is ObjectiveLessonPlan {
  if (obj == null || typeof obj !== 'object') return false
  return (
    'objectivePrerequisites' in obj &&
    (withStringReference
      ? isObjectivePrerequisitesWithStringReference(obj.objectivePrerequisites)
      : isObjectivePrerequisites(obj.objectivePrerequisites)) &&
    'startSteps' in obj &&
    isStrings(obj.startSteps) &&
    'segments' in obj &&
    isObjectiveLessonPlanSegments(obj.segments) &&
    'closureSteps' in obj &&
    isStrings(obj.closureSteps) &&
    'studentMaterialsNeeded' in obj &&
    isStrings(obj.studentMaterialsNeeded) &&
    'teacherMaterialsNeeded' in obj &&
    isStrings(obj.teacherMaterialsNeeded) &&
    'grades' in obj &&
    isStringGrades(obj.grades) &&
    'comments' in obj &&
    isStrings(obj.comments)
  )
}
export function isObjectiveLessonPlans(
  obj: unknown,
  withStringReference: boolean = false,
): obj is ObjectiveLessonPlan[] {
  if (obj == null || !Array.isArray(obj)) return false
...
export type ObjectiveLessonPlanWithStringReference = ReplaceReferencesByStrings<
  UnitReference,
  ReplaceReferencesByStrings<ObjectiveReference, ObjectiveLessonPlan>
>
export function isObjectiveLessonPlanWithStringReference(
  obj: unknown,
): obj is ObjectiveLessonPlanWithStringReference {
  return isObjectiveLessonPlan(obj, true)
}
export function isObjectiveLessonPlansWithStringReference(
  obj: unknown,
): obj is ObjectiveLessonPlanWithStringReference[] {
  if (obj == null || !Array.isArray(obj)) return false
...
export function isObjectivePrerequisite(
  obj: unknown,
  withStringReference: boolean = false,
): obj is ObjectivePrerequisite {
  if (obj == null || typeof obj !== 'object') return false
  return (
    'title' in obj &&
    typeof obj.title === 'string' &&
...
export function isObjectivePrerequisites(
  obj: unknown,
  withStringReference: boolean = false,
): obj is ObjectivePrerequisite[] {
  if (obj == null || !Array.isArray(obj)) return false
...
export type ObjectivePrerequisiteWithStringReference =
  ReplaceReferencesByStrings<
    UnitReference,
    ReplaceReferencesByStrings<ObjectiveReference, ObjectivePrerequisite>
  >
export function isObjectivePrerequisiteWithStringReference(
  obj: unknown,
): obj is ObjectivePrerequisiteWithStringReference {
  return isObjectivePrerequisite(obj, true)
}
export function isObjectivePrerequisitesWithStringReference(
  obj: unknown,
): obj is ObjectivePrerequisiteWithStringReference[] {
  if (obj == null || !Array.isArray(obj)) return false
...
export function isObjectiveUnit(
  obj: unknown,
  withStringReference: boolean = false,
): obj is ObjectiveUnit {
  if (obj == null || typeof obj !== 'object') return false
  return (
    'reference' in obj &&
    (withStringReference
...
export function isObjectiveUnits(
  obj: unknown,
  withStringReference: boolean = false,
): obj is ObjectiveUnit[] {
  if (obj == null || !Array.isArray(obj)) return false
...
export function isObjectiveDownloadLinks(
  obj: unknown,
): obj is ObjectiveDownloadLinks {
  if (obj == null || typeof obj !== 'object') return false
  return (
    'practiceSheetLink' in obj &&
    typeof obj.practiceSheetLink === 'string' &&
    'testSheetLink' in obj &&
    typeof obj.testSheetLink === 'string' &&
    'lessonPlanLinks' in obj &&
    isStringArrayRecordStringGrade(obj.lessonPlanLinks)
  )
}
...
export function isObjective(
  ...
  return (
    'ancestors' in obj &&
    isObjectiveAncestors(obj.ancestors, withStringReference) &&
    'ancestorsCount' in obj &&
    typeof obj.ancestorsCount === 'number' &&
    'descendants' in obj &&
    isObjectiveDescendants(obj.descendants, withStringReference) &&
    'descendantsCount' in obj &&
    typeof obj.descendantsCount === 'number' &&
    'downloadLinks' in obj &&
    isObjectiveDownloadLinks(obj.downloadLinks) &&
    'examExercises' in obj &&
    isObjectiveExercises(obj.examExercises) &&
    'examExercisesLink' in obj &&
    typeof obj.examExercisesLink === 'string' &&
    'exercises' in obj &&
    isObjectiveExercises(obj.exercises) &&
    'exercisesLink' in obj &&
    typeof obj.exercisesLink === 'string' &&
    'grade' in obj &&
    isStringGrade(obj.grade) &&
    'isAutomaticity' in obj &&
    typeof obj.isAutomaticity === 'boolean' &&
    ...
    'lessonPlans' in obj &&
    isObjectiveLessonPlans(obj.lessonPlans) &&
    'lessonSummaryHTML' in obj &&
    typeof obj.lessonSummaryHTML === 'string' &&
    'lessonSummaryImage' in obj &&
    typeof obj.lessonSummaryImage === 'string' &&
    'lessonSummaryImageAlt' in obj &&
    ...
    typeof obj.titleAcademic === 'string' &&
    'units' in obj &&
    isObjectiveUnits(obj.units, withStringReference) &&
    'videos' in obj &&
    isObjectiveVideos(obj.videos)
  )
}
export function isObjectives(
  obj: unknown,
  withStringReference: boolean = false,
): obj is Objective[] {
  if (obj == null || !Array.isArray(obj)) return false
...
export type ObjectiveWithStringReference = ReplaceReferencesByStrings<
  UnitReference,
  ReplaceReferencesByStrings<ObjectiveReference, Objective>
>
export function isObjectiveWithStringReference(
  obj: unknown,
): obj is ObjectiveWithStringReference {
  return isObjective(obj, true)
}
export function isObjectivesWithStringReference(
  obj: unknown,
): obj is ObjectiveWithStringReference[] {
  if (obj == null || !Array.isArray(obj)) return false
