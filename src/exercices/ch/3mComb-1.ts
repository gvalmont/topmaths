...
export default class Anagrammes extends Exercice {
  ...
  nouvelleVersion() {
    ...
    const motsRepetitionSimple = [
      ...
      { mot: 'GARAGE', repetitions: { A: 2 } },
      { mot: 'BAGAGE', repetitions: { A: 2, G: 2 } },
      { mot: 'TORTUE', repetitions: { T: 2 } },
      { mot: 'KAYAK', repetitions: { K: 2, A: 2 } },
      { mot: 'REVOLVER', repetitions: { R: 2, E: 2 } },
      { mot: 'CARAMEL', repetitions: { A: 2 } },
      { mot: 'CHOCOLAT', repetitions: { C: 2 } },
      { mot: 'COCORICO', repetitions: { C: 3, O: 2 } },
      { mot: 'ANNONCER', repetitions: { N: 3 } },
      { mot: 'RECOMMANDER', repetitions: { R: 2, M: 2 } },
      { mot: 'ADDITION', repetitions: { D: 2 } },
      { mot: 'PROGRAMME', repetitions: { R: 2, M: 2 } },
      { mot: 'GRAMMAIRE', repetitions: { A: 2, R: 2, M: 2 } },
      { mot: 'LITTERATURE', repetitions: { T: 3, E: 2 } },
      { mot: 'INNOCENT', repetitions: { N: 3 } },
      { mot: 'PRINCESSE', repetitions: { S: 2 } },
      { mot: 'ACCESSOIRE', repetitions: { C: 2, S: 2 } },
      { mot: 'COMMANDANT', repetitions: { M: 2, A: 2 } },
    ]
    ...
    const motsRepetitionsMultiples = [
      ...
      { mot: 'BAOBAB', repetitions: { B: 2, A: 2 } },
      ...
      { mot: 'TENNESSEE', repetitions: { E: 3, N: 2, S: 2 } },
