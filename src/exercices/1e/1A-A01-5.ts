...
import Question3 from '../EAMPremiere/EAM-CETechno-2026-Q3'
import Question4 from '../EAMPremiere/EAM-CETechno-2026-Q4'
import Question5 from '../EAMPremiere/EAM-CETechno-2026-Q5'
import Question6 from '../EAMPremiere/EAM-CETechno-2026-Q6'
import Question7 from '../EAMPremiere/EAM-CETechno-2026-Q7'
import Question8 from '../EAMPremiere/EAM-CETechno-2026-Q8'
import MetaExercice from '../MetaExerciceCan'
export const titre = 'Centres Étrangers Techno'
export const interactifReady = true
export const uuid = 'c9e5e'
export const refs = {
  'fr-fr': ['1A-A01-5'],
  'fr-ch': [],
}
