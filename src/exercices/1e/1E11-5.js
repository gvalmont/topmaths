  ...
  nouvelleVersion() {
    ...
    for (
      ...
      if (delta < 0) {
        ...
        texteCorr +=
          "<br>Le discriminant étant positif, d'après le cours, l'équation admet deux solutions réelles :"
        texteCorr +=
        ...
        if (b2.estParfaite) {
          if (a < 0) {
            x2 = alpha
              .simplifie()
              .sommeFraction(b2.racineCarree().simplifie().oppose())
              .simplifie()
            x1 = alpha
              .simplifie()
              .sommeFraction(b2.racineCarree().simplifie())
              .simplifie()
          } else {
            x1 = alpha
              .simplifie()
