...
export default class EgaliteFG3 extends Exercice {
  ...
  constructor() {
    ...
    this.consigne = texteItalique(
      "D'après " + ajouterLien('https://nuage03.apps.education.fr/index.php/s/NZgmoFpcSCW8Cag?dir=/&editing=false&openfile=true', '« Sur le chemin de l\'égalité en mathématiques pour tous les élèves » - Académie de Versailles') + ' (source : femmes et maths)',
    )
    this.consigne +=
    ...
    this.commentaireDebat =
      texteGras('Pour débattre') + '.<br>Quelles sont les conséquences de cette répartition sur l\'égalité des tâches ménagères dans la famille ?<br>Et toi, participes-tu à certaines tâches ? Si oui, lesquelles ?'
  ...
  nouvelleVersion() {
    ...
    const correction2 =
      `Au total, $160+105=265$ minutes sont consacrées chaque jour aux tâches ménagères par le couple.<br>$\\dfrac{160}{265}\\approx 0{,}604=60\\,\\%$ (arrondi à l'unité) : les femmes assurent donc environ $${miseEnEvidence('60\\,\\%')}$ des tâches ménagères du couple.`
    ...
    const correction3 =
      `$\\dfrac{105}{265}\\approx 0{,}396=40\\,\\%$ (ou $100-60=40\\,\\%$) : les hommes assurent donc environ $${miseEnEvidence('40\\,\\%')}$ des tâches ménagères du couple.`
