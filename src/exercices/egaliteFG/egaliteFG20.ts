...
export default class EgaliteFG20 extends Exercice {
  ...
  constructor() {
    ...
    this.consigne +=
      ...
      (context.isHtml
        ? '<div class="not-prose" style="text-align:center; margin: 0.75rem 0;"><img src="/alea/images/egalite/reservoir-pompe-tasse.jpg" alt="Machine expresso : réservoir, pompe et tasse de 80 mL" style="max-width:380px; width:100%; height:auto;"></div>'
        : '') +
      ...
      (context.isHtml
        ? '<div class="not-prose" style="text-align:center; margin: 0.75rem 0;"><img src="/alea/images/egalite/graphe-volume-temps.jpg" alt="Graphique du volume de café (en mL) en fonction du temps (en s)" style="max-width:420px; width:100%; height:auto;"></div>'
        : '')
    this.nbQuestions = 6
  ...
  nouvelleVersion() {
    ...
    let texte0 =
      "D'après le graphique, quel est le temps de préchauffage de la machine ?"
    if (this.interactif)
      texte0 +=
        ajouteChampTexteMathLive(this, 0, '', { texteApres: 's' }) + '<br>'
    handleAnswers(this, 0, { reponse: { value: 25 } })
    const correction0 = `Sur le graphique, le café ne commence à couler qu'à partir de $x=25$ s : le temps de préchauffage est donc de $${miseEnEvidence('25')}$ secondes.`
    ...
    if (this.interactif)
      texte1 +=
        ajouteChampTexteMathLive(this, 1, '', { texteApres: 'mL' }) + '<br>'
    handleAnswers(this, 1, { reponse: { value: 20 } })
    const correction1 = `$f(30)=4\\times(30-25)=4\\times 5=${miseEnEvidence('20')}$ mL.`

    let texte2 =
      'Au bout de combien de temps la tasse contient-elle $60$ mL de café ?'
    if (this.interactif)
      texte2 +=
        ajouteChampTexteMathLive(this, 2, '', { texteApres: 's' }) + '<br>'
    handleAnswers(this, 2, { reponse: { value: 40 } })
    const correction2 = `On cherche $x$ tel que $4(x-25)=60$, soit $x-25=15$, donc $x=40$ : au bout de $${miseEnEvidence('40')}$ secondes.`
    ...
    const correction3 = `On cherche $x$ tel que $4(x-25)=80$, soit $x-25=20$, donc $x=45$ : la tasse est pleine au bout de $45$ secondes depuis le départ, soit $45-25=${miseEnEvidence('20')}$ secondes après la fin du préchauffage.`

    let texte4 =
      "Calculer l'image de $38$ par la fonction $f$. Interpréter ce résultat."
    if (this.interactif)
      texte4 +=
        ajouteChampTexteMathLive(this, 4, '', { texteApres: 'mL' }) + '<br>'
    handleAnswers(this, 4, { reponse: { value: 52 } })
    const correction4 = `$f(38)=4\\times(38-25)=4\\times 13=52$ : au bout de $38$ secondes, la tasse contient $${miseEnEvidence('52')}$ mL de café.`

    let texte5 =
      'La tasse déborde au bout de $50$ secondes. Quel est le volume de cette dernière ?'
    if (this.interactif)
      texte5 +=
        ajouteChampTexteMathLive(this, 5, '', { texteApres: 'mL' }) + '<br>'
    handleAnswers(this, 5, { reponse: { value: 100 } })
    const correction5 = `$f(50)=4\\times(50-25)=4\\times 25=100$ : la tasse a donc un volume de $${miseEnEvidence('100')}$ mL.`
