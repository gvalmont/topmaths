...
export default class EgaliteFGLycee17 extends Exercice {
  ...
  constructor() {
    ...
    this.commentaireDebat =
      ...
      ".<br>Au regard des résultats de la Partie A, comment le choix des enseignements de spécialité en classe de Première et de Terminale peut-il influencer cet écart d'admission ? Selon vous, d'autres facteurs (censure, représentations sociales des métiers, etc.) interviennent-ils également dans ce constat ?"
  ...
  nouvelleVersion() {
    ...
    const texte0 =
      'Traduire la situation par un arbre pondéré (sans justification).'
    const correction0 =
    ...
    let texte1 =
      "Calculer la probabilité $P(F\\cap A)$ que l'élève soit une fille et admise en CPGE."
    ...
    let texte2 =
      "Montrer que la probabilité de l'événement $A$ est égale à $0{,}24$."
    if (this.interactif) texte2 += ajouteChampTexteMathLive(this, 2) + '<br>'
    handleAnswers(this, 2, { reponse: { value: 0.24 } })
    const correction2 = `D'après la formule des probabilités totales : $P(A)=P(F)\\times P_F(A)+P(\\overline F)\\times P_{\\overline F}(A)=0{,}4\\times 0{,}15+0{,}6\\times 0{,}3=0{,}06+0{,}18=${miseEnEvidence('0{,}24')}$.`
    ...
    const correction3 = `$P_A(\\overline F)=\\dfrac{P(\\overline F\\cap A)}{P(A)}=\\dfrac{0{,}6\\times 0{,}3}{0{,}24}=\\dfrac{0{,}18}{0{,}24}=${miseEnEvidence('0{,}75')}$.`

    const texteQ4 =
      'Que peut-on dire en comparant $P_F(A)=0{,}15$ et $P_{\\overline F}(A)=0{,}3$ ?'
    this.autoCorrection[4] = {
      ...
      propositions: [
        {
          texte:
            "Les garçons ont environ deux fois plus de chances d'être admis en CPGE que les filles",
          statut: true,
        },
        {
          texte:
            "Les filles et les garçons ont des chances comparables d'être admis en CPGE",
          statut: false,
        },
      ],
    }
    ...
    this.autoCorrection[5] = {
      ...
      propositions: [
        {
          texte: 'La loi binomiale de paramètres $n=7$ et $p=0{,}24$',
          statut: true,
        },
        {
          texte: 'La loi binomiale de paramètres $n=50$ et $p=0{,}24$',
          statut: false,
        },
        {
          texte: 'La loi binomiale de paramètres $n=7$ et $p=0{,}4$',
          statut: false,
        },
      ],
    }
    ...
    const correction5 = `Chaque tirage est une épreuve de Bernoulli de paramètre $p=P(A)=0{,}24$ (succès = « admis en CPGE »), répétée $7$ fois de façon identique et indépendante (tirage avec remise) : $X$ suit donc la loi binomiale $${miseEnEvidence('\\mathcal{B}(7\\,;\\,0{,}24)')}$.`

    let texte6 =
      "Calculer la probabilité qu'un seul des sept élèves tirés au sort soit admis en CPGE (arrondie au centième)."
    if (this.interactif) texte6 += ajouteChampTexteMathLive(this, 6) + '<br>'
    handleAnswers(this, 6, { reponse: { value: 0.32 } })
    const correction6 = `$P(X=1)=\\dbinom{7}{1}\\times 0{,}24^1\\times 0{,}76^6\\approx ${miseEnEvidence('0{,}32')}$.`
    ...
    const correction7 = `$P(X\\geqslant 2)=1-P(X=0)-P(X=1)=1-0{,}76^7-0{,}32\\approx 1-0{,}15-0{,}32=${miseEnEvidence('0{,}53')}$.`
    ...
    const correction8 = `$E(X)=np=7\\times 0{,}24=${miseEnEvidence('1{,}68')}$ : en moyenne, sur un échantillon de $7$ élèves, environ $1{,}68$ (soit un peu moins de $2$) seront admis en CPGE.`
    ...
    const correction10 = `On cherche $n$ tel que $1-0{,}76^n\\geqslant 0{,}99$, soit $0{,}76^n\\leqslant 0{,}01$. On trouve $0{,}76^{16}\\approx 0{,}0124>0{,}01$ et $0{,}76^{17}\\approx 0{,}0094\\leqslant 0{,}01$ : il faut donc $${miseEnEvidence('n=17')}$.`
