...
export const titre =
  'Maryam Mirzakhani : trajectoires dans un hexagone régulier'
...
export default class EgaliteFGLycee5 extends Exercice {
  ...
  constructor() {
    ...
    this.commentaireApprofondir =
      ...
      '.<br>Proposer le même exercice dans un carré en travail autonome.'
  ...
  nouvelleVersion() {
    ...
    const texte0 =
      texteGras("Partie 1 : Propriétés de l'hexagone régulier") +
      '<br>Construction. Tracer un hexagone régulier inscrit dans un cercle de centre $O$ de rayon $6$ cm.'
    const correction0 =
    ...
    let texte1 =
      "Quelle est la mesure de l'angle au centre correspondant à chaque côté de l'hexagone ?"
    if (this.interactif)
      texte1 +=
    ...
    const texte6 =
      texteGras('Partie 3 : Ouverture sur la recherche mathématique') +
      "<br>Maryam Mirzakhani a étudié des trajectoires similaires sur des surfaces complexes (avec des trous ou des replis). À votre avis, pourquoi les mathématiciens s'intéressent-ils à la manière dont un point peut se déplacer ainsi sur une surface ?"
    const correction6 =
