...
export default class EgaliteFGLycee19 extends Exercice {
  ...
  constructor() {
    ...
    this.comment =
      'Piste 8 du livret : comment animer un débat à partir de cet exercice ?'
    this.commentaireApprofondir =
      ...
      ajouterLien(
        'https://www.youtube.com/watch?v=K33QXGzrH_M',
        'Absence des femmes dans le numérique : Les solutions existent (HUB Institute)',
      ) +
      '<br>' +
      ajouterLien(
        'https://www.youtube.com/watch?v=4DQo4hy5wMg',
  ...
  nouvelleVersion() {
    ...
    const correction0 = `$u_1=0{,}84\\times 150+20=126+20=146$ : en 2016, l'école compte $${miseEnEvidence('146')}$ étudiantes (une diminution malgré les mesures d'inclusivité).`
    ...
    this.autoCorrection[2] = {
      ...
      propositions: [
        {
          texte:
            'Oui, car elle est décroissante et minorée (par exemple par $0$)',
          statut: true,
        },
    ...
    const correction3 = `$V_{n+1}=u_{n+1}-125=0{,}84\\,u_n+20-125=0{,}84\\,u_n-105=0{,}84\\,(u_n-125)+0{,}84\\times 125-105=0{,}84\\,V_n+105-105=0{,}84\\,V_n$ (car $0{,}84\\times 125=105$) : $(V_n)$ est donc $${miseEnEvidence('\\text{géométrique de raison }0{,}84')}$.`

    let texte4 =
      'En déduire que, pour tout entier $n$, $u_n=25\\times 0{,}84^n+125$. Quel est le premier terme $V_0$ de la suite $(V_n)$ ?'
    if (this.interactif) texte4 += ajouteChampTexteMathLive(this, 4) + '<br>'
    handleAnswers(this, 4, { reponse: { value: 25 } })
    const correction4 = `$V_0=u_0-125=150-125=25$, donc $V_n=25\\times 0{,}84^n$ (suite géométrique), d'où $${miseEnEvidence('u_n=25\\times 0{,}84^n+125')}$.`

    let texte5 =
      'Déterminer la limite de $(u_n)$ quand $n$ tend vers $+\\infty$.'
    if (this.interactif) texte5 += ajouteChampTexteMathLive(this, 5) + '<br>'
    handleAnswers(this, 5, { reponse: { value: 125 } })
    const correction5 = `Comme $0<0{,}84<1$, on a $0{,}84^n\\to 0$ quand $n\\to +\\infty$, donc $u_n=25\\times 0{,}84^n+125\\to ${miseEnEvidence('125')}$.`

    const texteQ6 =
      "Les mesures d'inclusivité de l'école d'ingénieurs ont-elles été efficaces ?"
    this.autoCorrection[6] = {
      ...
      propositions: [
        {
          texte:
            "Totalement : le nombre d'étudiantes a fini par augmenter au-delà de 150",
          statut: false,
        },
        {
          texte:
        ...
        {
          texte:
            "Pas du tout : le nombre d'étudiantes continue de diminuer indéfiniment",
          statut: false,
        },
      ],
    }
