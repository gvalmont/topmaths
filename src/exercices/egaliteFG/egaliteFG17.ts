...
export default class EgaliteFG17 extends Exercice {
  ...
  constructor() {
    ...
    this.introBio +=
      (context.isHtml ? '<div class="not-prose" style="text-align:center; margin: 0.75rem 0;"><img src="/alea/images/egalite/lovelace.png" alt="Portrait d\'Ada Lovelace" style="width:130px; height:auto; border-radius:9999px; border:3px solid #f15929;"><p style="font-size:0.7rem; font-style:italic; opacity:0.7;">Ada Lovelace, Anglaise (1815-1852)</p></div>' : '') +
      '<br>' + texteGras('Saviez-vous que le premier programme informatique fût écrit par une femme ?') + '<br>' +
...
\\end{scratch}`
    ...
    let texte0 = 'Combien de variables comporte ce programme ? Donner leurs noms.'
    ...
    const correction1 =
      `Avec $\\text{réponse}=2$ : $A=2-7=-5$ et $B=3\\times 2+1=7$, donc $C=A\\times B=-5\\times 7=${miseEnEvidence('-35')}$.`
    ...
    const correction2 =
      `Avec $\\text{réponse}=-3$ : $A=-3-7=-10$ et $B=3\\times(-3)+1=-8$, donc $C=(-10)\\times(-8)=${miseEnEvidence('80')}$.`
    ...
    const correction3 =
      `Avec $\\text{réponse}=\\dfrac{19}{3}$ : $A=\\dfrac{19}{3}-7=-\\dfrac{2}{3}$ et $B=3\\times\\dfrac{19}{3}+1=20$, donc $C=-\\dfrac{2}{3}\\times 20=-\\dfrac{40}{3}$ (valeur exacte), soit environ $${miseEnEvidence('-13{,}33')}$.`
    ...
    const correction4 =
      `$(x-7)(3x+1)=3x^2+x-21x-7=${miseEnEvidence('3x^2-20x-7')}$.`
    ...
    const correction5 =
      `$2x(3x-7)-(7+3x^2+6x)=6x^2-14x-7-3x^2-6x=3x^2-20x-7$, qui est bien égal au développement de $(x-7)(3x+1)$ trouvé à la question précédente. $${miseEnEvidence("\\text{L'affirmation est donc vraie}")}$.`
