  ...
  versionAleatoire: () => void = () => {
    ...
    do {
      ...
      while (candidates.length < 3) {
        ...
        if (
          f.texFractionSimplifiee !== correct.texFractionSimplifiee &&
          !candidates.includes(f.texFractionSimplifiee)
        ) {
