...
export default class ProbaCond extends ExerciceSimple {
  ...
  nouvelleVersion() {
     ...
     */
    function distracteursValides (reponse: FractionEtendue, candidats: FractionEtendue[]): string[] {
      return candidats
      ...
      default: {
        ...
        switch (choixNotation) {
          case 1: {
            ...
            this.reponse = this.versionQcm ? `   $${reponse.texFractionSimplifiee}$` : reponse.texFractionSimplifiee
          ...
          case 2: {
            ...
            this.optionsChampTexte = { texteAvant: '<br>$P_{R_1}(\\overline{R_2})=$' }
          ...
          case 3: {
            ...
            this.optionsChampTexte = { texteAvant: '<br>$P_{\\overline{R_1}}(R_2)=$' }
          ...
          default: {
            ...
            this.reponse = this.versionQcm ? `   $${reponse.texFractionSimplifiee}$` : reponse.texFractionSimplifiee
            this.canReponseACompleter = '$P_{\\overline{R_1}}(\\overline{R_2})=\\ldots$'
            ...
            this.optionsChampTexte = { texteAvant: '<br>$P_{\\overline{R_1}}(\\overline{R_2})=$' }
