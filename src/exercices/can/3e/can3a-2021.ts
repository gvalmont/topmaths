        ...
        case 9:
          {
            ...
            k = randint(2, 4)
            const reponse = arrondi(prix * k, 2)
        ...
        case 15:
          {
            a = randint(1, 5) * 10
            p = randint(2, 9, 5) * 10
            const reponse = Math.round((a * p) / 100)
            texte = `$${p}\\,\\%$ de $${a}= $`
        ...
        case 25:
          {
            a = randint(2, 10) * 1000
            b = randint(2, 5)
            const reponse = Math.round(a * (1 + b / 100))
