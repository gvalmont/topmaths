...
La correction détaillée (ou pas) n'est utile que si on choisit une résolution par équation.`
    ...
    this.besoinFormulaire2Texte = [
      ...
      [
        ...
        "5 : Nombre d'éléments du motif N",
        '6 : Numéro du motif à trouver',
        '7 : Ensemble de ces 6 propositions',
      ].join('\n'),
    ]
    this.sup2 = '1-2-3-4-6'
    ...
    this.besoinFormulaire3Texte = [
      ...
      [
        ...
        `100 : pour choisir les motifs linéaires`,
        `101 : pour choisir les motifs affines`,
      ].join('\n'),
    ]
    this.sup3 = `0`
    ...
    for (
      ...
      const explain =
        ...
        Et que c'est aussi le nombre de formes à l'étape 1. Par conséquent, pour trouver le nombre de formes d'un motif il faut simplement multiplier par ${delta} le numéro du motif.`
          : `On constate que le nombre de formes augmente de $${delta}$ à chaque étape.<br>
        Cependant, il n'y a pas ${delta} forme${delta > 1 ? 's' : ''} sur le motif 1, mais ${pat.fonctionNb(1)}. Par conséquent, il faut multiplier le numéro du motif par ${delta} et ${b < 0 ? `retirer ${-b}` : `ajouter ${b}`}.`
      const pattern =
        'iterate3d' in pat
          ? new VisualPattern3D({
              initialCells: [],
      ...
      for (const q of typesQuestions) {
        ...
        Et que c'est aussi le nombre de formes à l'étape 1.<br>`
              ...
              explain2 = `On constate que le nombre de formes augmente de $${delta}$ à chaque étape.<br>
              Cependant, il n'y a pas ${delta} forme${delta > 1 ? 's' : ''} sur le motif 1, mais ${pat.fonctionNb(1)}, soit ${b < 0 ? `${-b} de moins` : `${b} de plus`}.<br>`
        ...
        Et que c'est aussi le nombre de formes à l'étape 1.<br>Par conséquent, pour trouver le numéro d'un motif dont on connait le nombre de formes, il faut simplement diviser ce nombre par ${delta} pour trouver le numéro.`
                    : `On constate que le nombre de formes augmente de $${delta}$ à chaque étape.<br>
        Cependant, il n'y a pas ${delta} forme${delta > 1 ? 's' : ''} sur le motif 1, mais ${pat.fonctionNb(1)}.<br>Par conséquent, il faut ${b < 0 ? `ajouter ${-b}` : `retirer ${b}`} au nombre de formes puis diviser le résultat par ${delta} : <br>
