...
export default function CalculEffectifFrequence () {
  ...
  this.nouvelleVersion = function () {
    ...
    for (let ee = 0, cpt = 0; ee < this.nbQuestions && cpt < 50;) { // Boucle principale où i+1 correspond au numéro de la question
      ...
      texte1 += ajouteChampTexteMathLive(this, 4 * ee + 1, 'largeur01 inline', { texteApres: sp() + '%' }) + '<br>'
      ...
      texte3 += ajouteChampTexteMathLive(this, 4 * ee + 3, 'largeur01 inline', { texteApres: sp() + '%' }) + '<br>'
