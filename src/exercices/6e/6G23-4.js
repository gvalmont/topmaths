...
export default function MesurerUnAngleAvecRapporteur () {
  ...
  this.nouvelleVersion = function () {
    ...
    for (let i = 0, texteAMC, posA, sudOuest, nordOuest, sudEst, nordEst, texte, texteCorr; i < this.nbQuestions; i++) {
      ...
      if (this.interactif) {
        texte += ajouteChampTexteMathLive(this, i * nbAngles, 'inline largeur01', { texteApres: ' °' })
      }
      ...
      if (nbAngles > 1) {
        ...
        if (this.interactif) {
          texte += ajouteChampTexteMathLive(this, i * nbAngles + 1, 'inline largeur01', { texteApres: ' °' })
        }
        ...
        if (nbAngles > 2) {
          ...
          if (this.interactif) {
            texte += ajouteChampTexteMathLive(this, i * nbAngles + 2, 'inline largeur01', { texteApres: ' °' })
          }
          ...
          if (nbAngles > 3) {
            ...
            if (this.interactif) {
              texte += ajouteChampTexteMathLive(this, i * nbAngles + 3, 'inline largeur01', { texteApres: ' °' })
            }
