...
export default class NomExercice extends Exercice {
  ...
  nouvelleVersion() {
    for (let i = 0, cpt = 0; i < this.nbQuestions && cpt < 50; ) {
      ...
      const yB = yA + uy
      const zB = zA + uz
      const valeurt = new FractionEtendue(
        ux * xM + uy * yM + uz * zM - (ux * xA + uy * yA + uz * zA),
        ux * ux + uy * uy + uz * uz,
      )
      const abscisseH = new FractionEtendue(
        xA * (ux * ux + uy * uy + uz * uz) +
          ux * (ux * xM + uy * yM + uz * zM - (ux * xA + uy * yA + uz * zA)),
        ux * ux + uy * uy + uz * uz,
      )
      const ordonneeH = new FractionEtendue(
        yA * (ux * ux + uy * uy + uz * uz) +
          uy * (ux * xM + uy * yM + uz * zM - (ux * xA + uy * yA + uz * zA)),
        ux * ux + uy * uy + uz * uz,
      )
      const coteH = new FractionEtendue(
        zA * (ux * ux + uy * uy + uz * uz) +
          uz * (ux * xM + uy * yM + uz * zM - (ux * xA + uy * yA + uz * zA)),
        ux * ux + uy * uy + uz * uz,
      )
      texte =
