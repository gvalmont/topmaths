...
export const titre =
  'Calculer une probabilité avec une probabilité conditionnelle (QCM Bac)'
...
$\\bullet~~$ $G$ :  "Le joueur gagne la partie" .<br><br>`
      : ''
    this.enonce +=
      "La probabilité que le joueur gagne la partie sachant qu'il a choisi le monde B est égale à :"
