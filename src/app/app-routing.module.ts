...
const routes: Routes = [
  ...
  { path: 'trophees/:ref', component: TropheesComponent, data: {title: 'topmaths.fr - Trophées'} },
  { path: 'jeux', component: JeuxComponent, data: {title: 'topmaths.fr - Jeux'} },
  ...
  { path: 'classement/:categorie', component: ClassementComponent, data: {title: 'topmaths.fr - Classement'} },
  ...
  { path: 'team/admin/:ref', component: EquipeModificationComponent, canActivate: [AuthguardGuard], data: {title: 'topmaths.fr - Modification de l\'équipe'}},
